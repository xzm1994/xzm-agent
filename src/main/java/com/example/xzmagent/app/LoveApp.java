package com.example.xzmagent.app;
...
public class LoveApp {
    ...
    public LoveApp(ChatClient.Builder builder, ChatMemory myJdbcChatMemory) {
    ...
    public LoveReport doChatWithReport(String message, String chatId) {
        LoveReport loveReport = chatClient
                .prompt()
                .system(SYSTEM_PROMPT + "每次对话后都要生成恋爱结果，标题为{用户名}的恋爱报告，内容为建议列表，并标注好每个建议的序号")
                .user(message)
                .advisors(spec -> spec.param(CHAT_MEMORY_CONVERSATION_ID_KEY, chatId)
    ...
    public String doChatWithTools(String message, String chatId) {
        ChatResponse response = chatClient
                ...
                .advisors(new MyLoggerAdvisor())
                .tools(allTools)
                .toolContext(Map.of("userName", "xzm"))
                .call()
                .chatResponse();
        String content = response.getResult().getOutput().getText();
        log.info("content: {}", content);
